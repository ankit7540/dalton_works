...
# Author : Ankit
#Date : 04162017
# Purpose : Extract data from DALTON output files for alpha xx, zz and compare to reference. Calculation is done for increasing order 
# of inter-nuclear distance, available in ascending order of file index. Result stored in a file called result with current folder name appended.
...
#read fname
fname="pex_"  # pre-index name
echo "You entered: $iv, $fname" ;
#---------------------------------------------------------------------------------------------
#Reference values: # change as you need.
